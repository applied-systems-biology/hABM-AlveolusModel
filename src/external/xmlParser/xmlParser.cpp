...
XMLCSTR XMLNode::getError(XMLError xerror)
{
    ...
    case eXMLErrorBase64DataSizeIsNotMultipleOf4: return _CXML("Warning: Base64-std::string length is not a multiple of 4");
    case eXMLErrorBase64DecodeTruncatedData:      return _CXML("Warning: Base64-std::string is truncated");
    case eXMLErrorBase64DecodeIllegalCharacter:   return _CXML("Error: Base64-std::string contains an illegal character");
...
XMLNode XMLNode::addChild(const XMLNode& childNode, int pos)
{
